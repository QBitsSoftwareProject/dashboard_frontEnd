...
function UpdateQuestionForm() {
    ...
    const fetchdatafromquestion = async() => {
        try{
            const questiondata = await axios.get(`http://localhost:3000/question/get-question-by-id/${id}`);
  ...
  const QuestionFormHandler = async () => {
    ...
    try {
      ...
      const questionResponse = await axios.post(`http://localhost:3000/question/update-question-by-id/${id}`, {
        question,
        imgurl:imgurl,
        options
      });
          ...
          <div className="create-Question-first-row">
            ...
            <div className="second-row">
                <input type = "file" onChange={onChangeFile}></input>
                 <br/>
                 <br/>
                 <img src = {ImgUrl} width = {175} height = {150} /><br/>
                  <button className = "img-btn" onClick={uploadImage}>Set image</button>
                    ...
                    <div className="material-container" key={index}>
                      ...
                      <div className="material-cont-buttons">
                        <button
                          ...
                          onClick={() => handleOptuionEditbtn(index,OptionText,OptionMark,_id)}
                        >
                          <FiEdit2 />
                        </button>
                        <button
