...
import { getMindRelaxingMethodById , updateMethodById} from "../../service/methodService";
...
const ResourceManagement = ({ onPageChange }) => {
  ...
  const handleUpdate = () => {
    ...
    updateMethodById(id,methodType,methodCategory,methodName,methodDescription,imageUrl,methodUrl);
        ...
        <div className="second-row"
          ...
          {filenameMethod ? (
              <div classname="methods" style={{ height:150 , justifyContent:'center',alignItems:'center',display: 'flex',width:310 }}>{filenameMethod.name}</div>
               ...
               ImgUrl && (
               <div>
               <div classname="methods" style={{ height:150 , justifyContent:'center',alignItems:'center',display: 'flex',width:310 }}>{methodName}</div>
              </div>
              )
               )}
               </div>
